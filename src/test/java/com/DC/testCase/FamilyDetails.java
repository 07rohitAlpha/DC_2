...
public class FamilyDetails extends BaseClass{
...
//	logger.info("Please click the Edit button");
	...
	fdp.ClickAddnewIdProof();
//	logger.info("Please click to add New button");
	Thread.sleep(2000);
	
//  ====AADHAR CARD NUMBER ==============		
	
	fdp.setIDProofType("AADHAR CARD");
//	logger.info("Please select the IDProof");
	Thread.sleep(2000);
		
	fdp.setIDProofNumber("11002782672722");
//	logger.info("Please enter the IDProof Number");
	Thread.sleep(2000);
		
	WebElement AadharCardbutton =driver.findElement(By.xpath("//input[@name='formField']"));
...
//	logger.info("Please click the Edit button");
	...
	fdp.setRemark("imitaion for laber graphic in any Form is legal & punishable");
//	logger.info("Edit the Remark data");
	Thread.sleep(2000);
	
	fdp.ClickUpdateButton();
//	logger.info("click to update button");
	Thread.sleep(2000);
