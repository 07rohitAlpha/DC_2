...
//===============Email===========================================
		...
		ep.setEmailType("GMAIL");
//		logger.info("Please select the mail type");
		Thread.sleep(3000);
		
		ep.setEmailId("Admin@gmail.com");
//		logger.info("Please enter the mail id");
		Thread.sleep(3000);
		
		
		ep.setEmailRemark("this Mail id is verified");
//		logger.info("Please enter the remark ");
		Thread.sleep(3000);
		
		ep.ClickEmailSubmit();
//		logger.info("Please click the submit ");
		Thread.sleep(3000);
