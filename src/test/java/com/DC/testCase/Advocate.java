...
public class Advocate extends BaseClass {
...
//	logger.info("Please Add new Id ");
	...
	app.setIDProofType2("PASSPORT");
//	logger.info("Please Select the Id type");
	Thread.sleep(2000);
	
	app.setIDProofNumber2("H1239876");
//	logger.info("Please enter the IDProof number");
	Thread.sleep(2000);
	
	WebElement AdvocateDeatilsButton1 = driver.findElement(By.xpath("//input[@name='attachments']"));
	...
	// Createing Object of Robot Class 
	Robot rf2 = new Robot();
	Thread.sleep(2000);
