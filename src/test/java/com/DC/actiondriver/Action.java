...
public abstract class Action extends BaseClass implements Interface {
 ...
 */
	...
	public boolean selectBySendkeys(String value, WebElement ele) {
		...
		if (flag) {
			...
			System.out.println("Not Selected vlaue from the dropdown");
	...
	public boolean selectByIndex(WebElement element, int index) {
		...
		try {
			...
			if(flag) {
				System.out.println("Option selected by inbox");
			}
		else {
			System.out.println("Option not selected by inbox");
		}
	}
	}
	 ...
	 * 
	 * @param valur :    Value wish to select form dropdown list.
	 * 
	 * @param locator Name    : Meaningful name to the element (Ex: Year Dropdwon, items
	 *                         Listbox etc..)
	 */
	...
	public boolean selectByValue(WebElement element, String value) {
		...
		if (flag) {
			...
			System.out.println("Option not selected by the value");
		}
	}
	}
	...
	public boolean selectByVisibleText(String visibletext, WebElement ele) {
		...
		try {
			...
			if (flag) {
				System.out.println("Option selected by the visibleText");
			} else {
	...
	public void mouseOverElement(WebDriver driver, WebElement element) {
		...
		try {
			...
			if (flag) {
				...
				System.out.println("MouseOver action is not performance on");
			}
		}
    ...
    try {
    	...
    	presentFlag= true;
    		...
    		if(!presentFlag) {
    			...
    			System.out.println("There was no alert to handled");
    		}
    	}
		return presentFlag;
	}
...
try {
	...
	if (flag) {
	System.out.println("Successfully launch\""+url+"\"");	
	}else {
...
//    String currentDate = new SimpleDataFormat("yyyy-MM-dd-hhmmss").format(new Date());
//		return currentDate;
//	}
